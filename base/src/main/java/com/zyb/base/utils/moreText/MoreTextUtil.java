package com.zyb.base.utils.moreText;
...
public class MoreTextUtil {
     ...
     */
    public MoreTextUtil(final TextView textView, String oriMsg, String textOpen, String textClose) {
        mTextView = textView;
        mOriMsg = oriMsg;
        mTextOpen = textOpen;
     ...
     * @param oriMsg   原始文字
     */
    public MoreTextUtil(final TextView textView, String oriMsg) {
        mTextView = textView;
        mOriMsg = oriMsg;
    }
     ...
     */
    public MoreTextUtil(final TextView textView, String oriMsg, Drawable drawableOpen, Drawable drawableColse) {
        mTextView = textView;
        mOriMsg = oriMsg + "XX";
     ...
     * @deprecated
     */
    public MoreTextUtil setLines(int lineNum) {
     ...
     *
     */
    public MoreTextUtil setLength(int length) {
        this.mLength = length;
        return this;
    }
     ...
     * @return 本类实例
     */
    public MoreTextUtil setSpanTextColor(int spanTextColor) {
    ...
    private SpannableString compressedWithString() {
        String resultText = mOriMsg.substring(0, mLength) + mTextOpen;
