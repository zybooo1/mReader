...
public class QMUIViewHelper {
    ...
    public static
    @Nullable
    TranslateAnimation slideIn(final View view, int duration, QMUIDirection direction) {
        return slideIn(view, duration, null, true, direction);
    }
    ...
    public static
    @Nullable
    TranslateAnimation slideOut(final View view, int duration, QMUIDirection direction) {
        return slideOut(view, duration, null, true, direction);
    }
