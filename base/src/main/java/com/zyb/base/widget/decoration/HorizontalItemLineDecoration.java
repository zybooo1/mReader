 ...
 */
public class HorizontalItemLineDecoration extends FlexibleDividerDecoration {

    private MarginProvider mMarginProvider;

    protected HorizontalItemLineDecoration(Builder builder) {
        super(builder);
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public HorizontalItemLineDecoration build() {
            checkBuilderParams();
            return new HorizontalItemLineDecoration(this);
        }
    }
}