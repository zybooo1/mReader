package com.zyb.base.widget.dialog;
...
import com.zyb.base.base.BaseDialogFragment;
import com.zyb.base.base.BaseRecyclerViewAdapter;
...
public final class AddressDialog {
    ...
    public static final class Builder
        ...
        public Builder(FragmentActivity activity) {
            ...
            mTabLayout.addTab(mTabLayout.newTab().setText(getString(R.string.base_select_hint)), true);
        ...
        public void onItemClick(RecyclerView recyclerView, View itemView, int position) {
            if (recyclerView == mRecyclerView1) {
                ...
                mTabLayout.addTab(mTabLayout.newTab().setText(getContext().getResources().getString(R.string.base_select_hint)), true);
        ...
        public void onTabSelected(TabLayout.Tab tab) {
            tab.setText(getString(R.string.base_select_hint));
