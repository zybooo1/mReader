...
public final class RoundButton extends android.support.v7.widget.AppCompatTextView {
    ...
    public RoundButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        int cornerRadius = a.getLayoutDimension(R.styleable.RoundButton_btnCornerRadius, -1);
        ...
        int strokeWidth = a.getDimensionPixelSize(R.styleable.RoundButton_btnStrokeWidth, 2);
