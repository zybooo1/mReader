...
import com.zyb.base.widget.dialog.widget.LoopView;
    ...
    public final static class Builder
        ...
        public Builder(FragmentActivity activity) {
            ...
            for (int i = START_YEAR; i <= EDN_YEAR; i++) {
                yearList.add(i + " " + getString(R.string.base_date_year));
            }

            // 生产月份
            ArrayList<String> monthList = new ArrayList<>(12);
            for (int i = 1; i <= 12; i++) {
                monthList.add(i + " " + getString(R.string.base_date_month));
            }
        ...
        public void onItemSelect(LoopView loopView, int position) {
            ...
            for (int i = 1; i <= day; i++) {
                dayList.add(i + " " + getString(R.string.base_date_day));
            }
