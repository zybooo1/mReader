...
import com.zyb.reader.widget.animation.CoverPageAnim;
import com.zyb.reader.widget.animation.HorizonPageAnim;
import com.zyb.reader.widget.animation.NonePageAnim;
import com.zyb.reader.widget.animation.PageAnimation;
import com.zyb.reader.widget.animation.ScrollPageAnim;
import com.zyb.reader.widget.animation.SimulationPageAnim;
import com.zyb.reader.widget.animation.SlidePageAnim;
        ...
        switch (pageMode){
            ...
            case PAGE_MODE_SCROLL:
                mPageAnim = new ScrollPageAnim(mViewWidth, mViewHeight, 0,
                        CommonUtils.dp2px(PageLoader.DEFAULT_MARGIN_HEIGHT),this,mPageAnimListener);
                break;
            default:
                mPageAnim = new SimulationPageAnim(mViewWidth, mViewHeight,this,mPageAnimListener);
        }
